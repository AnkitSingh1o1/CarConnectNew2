...
public class AddressService {
    ...
    public int softDeleteAddress(int addressId) throws SQLException, ResourceNotFoundException {
    ...
    public int updateById(Address address) throws SQLException, ResourceNotFoundException {
